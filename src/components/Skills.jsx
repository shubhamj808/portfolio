  ...
  <Tilt className="flex flex-wrap">
    ...
    >
      ...
      >
        ...
        <div
          id="skillList"
          className="flex justify-center flex-wrap gap-1 sm:gap-2 m-1 sm:m-2"
        >
          {skills.map((skill, index) => (
            <div
              id="skillItem"
              className="text-[12px] sm:text-[13px] font-normal text-white border rounded-xl flex items-center justify-center gap-1 sm:gap-2 p-1 sm:p-2 md:p-3 lg:p-4"
              key={index}
            >
              <img
...
const Skills = () => {
  return (
    <>
      ...
      <div
        id="skillsContainer"
        className="w-full flex flex-wrap mt-5 sm:mt-7 justify-center gap-3 sm:gap-5 md:gap-7"
      >
